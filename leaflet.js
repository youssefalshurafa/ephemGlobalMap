...
!(function (t, i) {
    ...
    function l(t, i) {
        t.hasOwnProperty('options') ||
            (t.options = t.options ? Qt(t.options) : {});
    ...
    function J(t) {
        return (
            V(t, 'mousedown touchstart dblclick', Y), G(t, 'click', et), this
        );
    }
    function $(t) {
        return (
    ...
    function Wt(t, i) {
        ...
        switch (r.type) {
            ...
            case 'MultiLineString':
                return (
                    (n = Ft(a, 'LineString' === r.type ? 0 : 1, l)),
                    new tn(n, i)
                );
            case 'Polygon':
            case 'MultiPolygon':
                return (
                    (n = Ft(a, 'Polygon' === r.type ? 1 : 2, l)), new en(n, i)
                );
    ...
    if ('onselectstart' in document)
        ...
        (mi = function () {
            ...
            (fi = function () {
                ge &&
                    ((document.documentElement.style[ge] = gi), (gi = void 0));
            });
    }
    var ve,
        ye,
        ...
        Le = ui.extend({
            ...
            initialize: function (t, i) {
                (i = l(this, i)),
                    ...
                    this.callInitHooks(),
                    (this._zoomAnimated =
                        me && Ni && !qi && this.options.zoomAnimation),
                    this._zoomAnimated &&
    ...
    var Te = Pe.extend({
            ...
            addTo: function (t) {
                return (
                    Pe.prototype.addTo.call(this, t),
            ...
            collapse: function () {
                return (
                    mt(this._container, 'leaflet-control-layers-expanded'), this
                );
            },
            _initLayout: function () {
                    ...
                    if (t.touches && t.touches.length > 1) this._moved = !0;
                        ...
                        var i =
                                t.touches && 1 === t.touches.length
                                    ? t.touches[0]
                                    : t,
                            e = new x(i.clientX, i.clientY).subtract(
                                this._startPoint
                            );
                        (e.x || e.y) &&
    ...
    var Ve = Ue.extend({
        ...
        $e = Je.extend({
            ...
            setStyle: function (t) {
                ...
                return (
                    Je.prototype.setStyle.call(this, t), this.setRadius(i), this
                );
            },
            _project: function () {
        ...
        un = hn.extend({
            ...
            onAdd: function (t) {
                hn.prototype.onAdd.call(this, t),
                    ...
                    this._source &&
                        ...
                        this._source instanceof Je ||
                            this._source.on('preclick', Y));
            },
            onRemove: function (t) {
            ...
            _adjustPan: function () {
                if (
                    ...
                    var t = this._map,
                        i =
                            parseInt(at(this._container, 'marginBottom'), 10) ||
                            0,
    ...
    var ln = hn.extend({
        ...
        getEvents: function () {
            var t = hn.prototype.getEvents.call(this);
            return (
                Vi && !this.options.permanent && (t.preclick = this._close), t
            );
        },
        _close: function () {
    ...
    var _n = Ue.extend({
            ...
            bringToFront: function () {
                return (
                    this._map &&
                        (ct(this._container), this._setAutoZIndex(Math.max)),
                    this
                );
            },
            bringToBack: function () {
                return (
                    this._map &&
                        (_t(this._container), this._setAutoZIndex(Math.min)),
                    this
                );
            },
            getContainer: function () {
            ...
            _abortLoading: function () {
                ...
                for (t in this._tiles)
                    this._tiles[t].coords.z !== this._tileZoom &&
                        ...
                        (i.onerror = r),
                        i.complete ||
                            ((i.src = ni), ut(i), delete this._tiles[t]));
            },
        }),
        pn = dn.extend({
            defaultWmsParams: {
    ...
    var mn = Ue.extend({
            ...
            onAdd: function () {
                this._container ||
                    (this._initContainer(),
                    this._zoomAnimated &&
                        pt(this._container, 'leaflet-zoom-animated')),
                    this.getPane().appendChild(this._container),
                    this._update(),
        ...
        Le.include({
            getRenderer: function (t) {
                ...
                return (
                    i ||
                        (i = this._renderer =
                            (this.options.preferCanvas && Xt()) || Jt()),
    ...
    var Ln = Ze.extend({
        ...
        _finish: function () {
            this._moved &&
                (ut(this._box), mt(this._container, 'leaflet-crosshair')),
                fi(),
                Tt(),
                q(
                    document,
