...
(function () {
    ...
    L.OWM.precipitationClassic = function (options) {
        ...
        if (layer.options.legendImagePath == null) {
            layer.options.legendImagePath =
                'https://openweathermap.org/img/a/PR.png';
        }
        return layer;
    };
    ...
    L.OWM.rainClassic = function (options) {
        ...
        if (layer.options.legendImagePath == null) {
            layer.options.legendImagePath =
                'https://openweathermap.org/img/a/RN.png';
        }
        return layer;
    };
    ...
    L.OWM.snow = function (options) {
        ...
        if (layer.options.legendImagePath == null) {
            layer.options.legendImagePath =
                'https://openweathermap.org/img/a/SN.png';
        }
        return layer;
    };
    ...
    L.OWM.cloudsClassic = function (options) {
        ...
        if (layer.options.legendImagePath == null) {
            layer.options.legendImagePath =
                'https://openweathermap.org/img/a/NT.png';
        }
        return layer;
    };
    ...
    L.OWM.pressure = function (options) {
        ...
        if (layer.options.legendImagePath == null) {
            layer.options.legendImagePath =
                'https://openweathermap.org/img/a/PN.png';
        }
        return layer;
    };
    ...
    L.OWM.temperature = function (options) {
        ...
        if (layer.options.legendImagePath == null) {
            layer.options.legendImagePath =
                'https://openweathermap.org/img/a/TT.png';
        }
        return layer;
    };
    ...
    L.OWM.wind = function (options) {
        ...
        if (layer.options.legendImagePath == null) {
            layer.options.legendImagePath =
                'https://openweathermap.org/img/a/UV.png';
        }
        return layer;
    };
})();
...
L.OWM.Current = L.Layer.extend({
    ...
    _processRequestedData: function (_this, data) {
        ...
        for (var key in stations) {
            ...
            if (
                ...
                marker = _this.options.markerFunction.call(
                    _this,
                    stations[key]
                );
            } else {
        ...
        if (typeof station.wind != 'undefined') {
            ...
            if (typeof station.wind.deg != 'undefined') {
                ...
                if (
                    ...
                    txt +=
                        this._directions[(station.wind.deg / 22.5).toFixed(0)];
    ...
    _getImageData: function (station) {
        ...
        if (station.weather && station.weather[0] && station.weather[0].icon) {
            imageUrl = imageUrlTemplate.replace(
                '{icon}',
                station.weather[0].icon
            );
    ...
    _displayTemperatureUnit: function () {
        ...
        if (
            typeof this._tempUnits[this.options.temperatureUnit] != 'undefined'
        ) {
...
L.OWM.CurrentCache = L.Class.extend({
    ...
    get: function (minLon, minLat, maxLon, maxLat) {
        ...
        if (
            new Date().getTime() - this._cachedTime >
            60000 * this.options.maxAge
        ) {
